...
export default function LandingPage({ setView, setAuthRole }: LandingPageProps) {
  ...
  return (
    <div className="space-y-32 relative overflow-hidden pb-16">
      ...
      <div className="absolute top-[-10%] right-[-10%] w-[600px] h-[600px] bg-gradient-to-tr from-[#4f8cff]/10 to-[#7c5cff]/5 rounded-full blur-[160px] pointer-events-none animate-pulse-slow" />
      <div className="absolute top-[40%] left-[-15%] w-[500px] h-[500px] bg-gradient-to-tr from-[#7c5cff]/8 to-[#4f8cff]/5 rounded-full blur-[140px] pointer-events-none" />
      ...
      >
        ...
        <div className="lg:col-span-7 space-y-8 text-left">
          ...
          <motion.div variants={itemVariants} className="inline-flex">
            <div className="inline-flex items-center gap-2 bg-[#4f8cff]/10 border border-[#4f8cff]/20 px-4 py-1.5 rounded-full text-xs font-bold text-[#5da9ff] tracking-wide uppercase shadow-lg backdrop-blur-md">
              <Sparkles className="w-4.5 h-4.5 text-[#5da9ff] animate-pulse" />
          ...
          <motion.h1 variants={itemVariants} className="font-display text-4xl sm:text-6.5xl font-black text-white tracking-tight leading-[1.08]">
            ...
            <span className="bg-gradient-to-r from-[#4f8cff] via-[#9476ff] to-[#7c5cff] bg-clip-text text-transparent">
          ...
          <motion.p variants={itemVariants} className="text-slate-300 text-sm sm:text-base max-w-xl leading-relaxed">
            SIHRMS dismantles fragmented medical silos. Securely compile certified diagnostics, govern access locks with cryptographic permission keys, and authorize doctors instantly across any network clinic.
          </motion.p>
          ...
          <motion.div variants={itemVariants} className="flex flex-col sm:flex-row items-center gap-4 pt-2">
            <button 
              ...
              className="w-full sm:w-auto relative overflow-hidden group bg-gradient-to-r from-[#4f8cff] to-[#7c5cff] text-white shadow-[0_0_30px_rgba(79,140,255,0.3)] hover:shadow-[0_0_40px_rgba(79,140,255,0.5)] px-8 py-4 rounded-2xl font-bold text-sm tracking-wide transition-all hover:scale-[1.03] active:scale-[0.98] flex items-center justify-center gap-2 cursor-pointer"
            >
              <span className="relative z-10 flex items-center gap-2">
                Initialize Patient Vault
                <ArrowRight className="w-4.5 h-4.5 group-hover:translate-x-1 transition-transform" />
              </span>
              <span className="absolute inset-0 bg-gradient-to-r from-[#7c5cff] to-[#4f8cff] opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
            </button>
            
            <button 
              onClick={() => { setAuthRole('doctor'); setView('login'); }} 
              className="w-full sm:w-auto bg-[#0f172a]/80 hover:bg-[#1e293b] text-white border border-white/10 hover:border-white/20 shadow-md px-8 py-4 rounded-2xl font-bold text-sm tracking-wide transition-all hover:scale-[1.03] active:scale-[0.98] flex items-center justify-center gap-2 cursor-pointer backdrop-blur-md"
            >
              <Stethoscope className="w-4.5 h-4.5 text-[#5da9ff]" />
              Practitioner Entry
            </button>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="pt-6 border-t border-white/5 flex flex-wrap gap-x-6 gap-y-3">
            <div className="flex items-center gap-2 text-xs text-slate-400 font-medium">
              <Shield className="w-4.5 h-4.5 text-[#4f8cff]" />
            ...
            <div className="flex items-center gap-2 text-xs text-slate-400 font-medium">
              <RefreshCw className="w-4.5 h-4.5 text-[#7c5cff]" />
        ...
        >
          ...
          <div className="absolute w-[360px] h-[360px] rounded-full border border-[#4f8cff]/15 border-dashed animate-[spin_24s_infinite_linear]" />
          ...
          <motion.div 
            ...
            animate="animate"
            className="w-full max-w-[380px] bg-gradient-to-br from-white/10 to-white/0 backdrop-blur-2xl rounded-[32px] p-6 border border-white/15 shadow-[0_20px_50px_rgba(0,0,0,0.5)] space-y-6 relative"
          >
            {/* Glowing node connections lines */}
            <div className="absolute top-0 left-12 w-[1px] h-full bg-gradient-to-b from-transparent via-[#4f8cff]/20 to-transparent" />
            
            {/* Animated medical timeline preview header */}
            <div className="flex items-center justify-between pb-4 border-b border-white/10">
              <div className="flex items-center gap-2.5">
                <div className="h-9 w-9 rounded-xl bg-gradient-to-tr from-[#4f8cff] to-[#7c5cff] flex items-center justify-center text-white">
                  <Activity className="w-5 h-5 animate-pulse" />
                </div>
                <div>
                  <span className="block text-xs font-bold text-white">Universal Clinical ID</span>
                  <span className="block text-[9px] text-[#5da9ff] font-mono">PAT-80924039</span>
                </div>
              </div>
            ...
            <div className="space-y-3.5 relative">
              ...
              <div className="relative pl-7 space-y-1">
                <div className="absolute left-[9px] top-1.5 h-2 w-2 rounded-full bg-[#4f8cff] ring-4 ring-[#4f8cff]/25" />
            ...
            <div className="bg-slate-950/50 rounded-2xl p-3 border border-white/5 space-y-2">
              <div className="flex items-center justify-between text-[9px] font-mono text-slate-400">
                ...
                <span className="text-[#5da9ff] font-bold">60 FPS</span>
              </div>
              <svg viewBox="0 0 100 25" className="w-full h-8 stroke-[#4f8cff] fill-none stroke-[1.5] overflow-visible">
                <path d="M 0,12.5 L 20,12.5 L 25,2 L 30,23 L 35,12.5 L 55,12.5 L 60,7 L 65,18 L 70,12.5 L 100,12.5" />
                <circle cx="25" cy="2" r="1.5" className="fill-white stroke-[#4f8cff]" />
                <circle cx="30" cy="23" r="1.5" className="fill-white stroke-[#4f8cff]" />
              </svg>
            </div>
      ...
      <div className="relative z-10">
        <div className="absolute inset-0 bg-gradient-to-r from-transparent via-[#4f8cff]/5 to-transparent blur-2xl" />
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
          
          <div className="glass-card rounded-2xl p-6 border border-white/5 text-center space-y-1 hover:border-[#4f8cff]/20 transition duration-300">
            <div className="text-3xl sm:text-4xl font-display font-black text-white font-mono bg-gradient-to-r from-[#4f8cff] to-white bg-clip-text text-transparent">100%</div>
          ...
          <div className="glass-card rounded-2xl p-6 border border-white/5 text-center space-y-1 hover:border-[#4f8cff]/20 transition duration-300">
            <div className="text-3xl sm:text-4xl font-display font-black text-white font-mono bg-gradient-to-r from-[#7c5cff] to-white bg-clip-text text-transparent">24H</div>
          ...
          <div className="glass-card rounded-2xl p-6 border border-white/5 text-center space-y-1 hover:border-[#4f8cff]/20 transition duration-300">
            <div className="text-3xl sm:text-4xl font-display font-black text-white font-mono bg-gradient-to-r from-pink-400 to-white bg-clip-text text-transparent">Zero</div>
      ...
      <div className="space-y-12 relative z-10">
        ...
        <div className="text-center space-y-3 max-w-2xl mx-auto">
          <span className="text-[10px] uppercase font-bold tracking-widest text-[#4f8cff] font-mono bg-[#4f8cff]/10 px-3 py-1 rounded-full border border-[#4f8cff]/15">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {/* Card 1 */}
          <motion.div 
            whileHover={{ y: -6, borderColor: "rgba(79,140,255,0.25)" }}
          ...
          >
            <div className="space-y-4">
              <div className="h-12 w-12 rounded-2xl bg-[#4f8cff]/10 border border-[#4f8cff]/25 flex items-center justify-center text-[#4f8cff] shadow-inner">
            ...
            <div className="pt-4 border-t border-white/5 flex items-center gap-2 text-[10px] font-mono font-bold text-[#4f8cff] uppercase tracking-wide">
          ...
          {/* Card 2 */}
          <motion.div 
            whileHover={{ y: -6, borderColor: "rgba(124,92,255,0.25)" }}
            className="glass-card rounded-[24px] p-8 space-y-6 flex flex-col justify-between transition-all duration-300 border border-white/5"
          >
            <div className="space-y-4">
              <div className="h-12 w-12 rounded-2xl bg-[#7c5cff]/10 border border-[#7c5cff]/25 flex items-center justify-center text-[#7c5cff] shadow-inner">
            ...
            <div className="pt-4 border-t border-white/5 flex items-center gap-2 text-[10px] font-mono font-bold text-[#7c5cff] uppercase tracking-wide">
      ...
      <div className="space-y-16 relative z-10">
        ...
        <div className="text-center space-y-3 max-w-2xl mx-auto">
          <span className="text-[10px] uppercase font-bold tracking-widest text-[#7c5cff] font-mono bg-[#7c5cff]/10 px-3 py-1 rounded-full border border-[#7c5cff]/15">
            Operational Lifecycle
          </span>
          <h2 className="font-display text-2xl sm:text-4.5xl font-black text-white tracking-tight">
            How The SIHRMS Ecosystem Syncs.
          </h2>
          <p className="text-slate-400 text-xs sm:text-sm">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 max-w-6xl mx-auto relative">
          ...
          <div className="hidden lg:block absolute top-[44px] left-[15%] right-[15%] h-[2px] bg-gradient-to-r from-[#4f8cff]/30 via-[#7c5cff]/30 to-[#4f8cff]/30 z-0" />
          ...
          <div className="glass-card rounded-3xl p-6 border border-white/5 text-left space-y-4 relative z-10">
            <div className="h-14 w-14 rounded-2xl bg-[#090d23]/90 border border-white/10 flex items-center justify-center text-white relative shadow-md">
              <span className="absolute top-2 right-2 text-[9px] font-mono font-extrabold text-[#4f8cff]">01</span>
              <Key className="w-6 h-6 text-[#4f8cff]" />
            </div>
          ...
          <div className="glass-card rounded-3xl p-6 border border-white/5 text-left space-y-4 relative z-10">
            <div className="h-14 w-14 rounded-2xl bg-[#090d23]/90 border border-white/10 flex items-center justify-center text-white relative shadow-md">
              <span className="absolute top-2 right-2 text-[9px] font-mono font-extrabold text-[#7c5cff]">02</span>
          ...
          <div className="glass-card rounded-3xl p-6 border border-white/5 text-left space-y-4 relative z-10">
            <div className="h-14 w-14 rounded-2xl bg-[#090d23]/90 border border-white/10 flex items-center justify-center text-white relative shadow-md">
              <span className="absolute top-2 right-2 text-[9px] font-mono font-extrabold text-[#5da9ff]">03</span>
              <Users className="w-6 h-6 text-[#5da9ff]" />
            </div>
            <div className="space-y-1">
